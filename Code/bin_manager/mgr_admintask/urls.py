...
urlpatterns = [
    ...
    path('manage_customer/',views.manageCustomer.as_view(),name='manage_customer'),
    path('search_customer/',views.viewCustomerDetails.as_view(),name='search_customer'),
    # path('view_customer/<int:id>/',views.viewCustomerDetails.as_view(),name='view_customer'),
